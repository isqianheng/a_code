...
public class FindInJar {  
    ...
    public static void main(String args[]) {  
        //要查找的类  
            FindInJar findInJar = new FindInJar("com.dcfs.branch.prod.tools.SopIntf");  
        //jar包所在的位置  
            List jarFiles = findInJar.findClass("E:/program_xian/code/SmartTeller_PS/lib", true);  //   E:/cc_work
            if (jarFiles.size() == 0) {  
